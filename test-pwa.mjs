...
assert(popHandler.includes("lockHomeHistory()"), "home trap is re-armed during popstate");
assert(popHandler.includes("setTimeout(lockHomeHistory"), "home trap is re-armed again after popstate");
