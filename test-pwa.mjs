...
const popHandler = app.slice(app.indexOf("function handleHistoryPop"), app.indexOf("function stayOnHome"));
assert(popHandler.includes("armHomeHistory()"), "home trap is re-armed during popstate");
assert(popHandler.includes("setTimeout(armHomeHistory"), "home trap is re-armed again after popstate");
