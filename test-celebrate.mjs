...
assert(shouldCelebrate({ answered: 10, correct: 10, difficulty: "hard" }), "hard perfect");
assert(shouldCelebrate({ answered: 4, correct: 4, difficulty: "challenge" }), "challenge perfect");
...
assert(!shouldCelebrate({ answered: 10, correct: 10, difficulty: "medium" }), "medium no party");
