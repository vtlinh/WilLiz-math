...
4. Run `node --experimental-default-type=module test-problems.mjs`, `node --experimental-default-type=module test-storage.mjs`, and `node --experimental-default-type=module test-worksheet.mjs`.
